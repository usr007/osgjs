...
utils.createPrototypeObject(Stats, {
    ...
    _init: function(options) {
        ...
        manager.group(Groups.STATS).addMappings(
            {
        ...
        manager.setPriority(Groups.STATS, manager.getHigherPriority(Groups.SCENE));
    ...
    onMouseDown: function(e) {
        ...
        this._viewer.getInputManager().setEnable(Groups.SCENE, false);
    ...
    onMouseUp: function() {
        this._viewer.getInputManager().setEnable(Groups.SCENE, true);
        this._onStats = false;
    },
